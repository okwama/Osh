...
import 'package:woosh/services/core/reports/product_sample_service.dart';
...
class _ProductSamplePageState extends State<ProductSamplePage> {
  ...
  Future<void> _submitCart() async {
    ...
    try {
      ...
      // Use new ProductSampleService to submit report
      await ProductSampleService.submitProductSampleReport(
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('Product sample report submitted successfully'),
              ],
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      maxLines: 2,
                      decoration: InputDecoration(
                        labelText: 'Reason for Sample',
                        hintText:
                            'Enter the reason for sampling this product...',
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(8),
                        ),
                        focusedBorder: OutlineInputBorder(
